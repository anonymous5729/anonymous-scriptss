...
╭━╮╱╭╮╱╱╱╱╱╱╱╱╭╮╱╱╱╱╱╱╱╱╱╱╭━━━╮╱╭╮            |
┃┃╰╮┃┃╱╱╱╱╱╱╱╱┃┃╱╱╱╱╱╱╱╱╱╱┃╭━╮┃╱┃┃            |
┃╭╮╰╯┣━━┳╮╭┳━━┫┃╭━━┳━━┳━━╮┃┃╱┃┣━╯┣╮╭┳┳━╮     | Welcome to the Bandu’s Admin source, feel free to take a look around.
┃┃╰╮┃┃╭╮┃╰╯┃┃━┫┃┃┃━┫━━┫━━┫┃╰━╯┃╭╮┃╰╯┣┫╭╮╮    | Enjoy.
┃┃╱┃┃┃╭╮┃┃┃┃┃━┫╰┫┃━╋━━┣━━┃┃╭━╮┃╰╯┃┃┃┃┃┃┃┃    |
╰╯╱╰━┻╯╰┻┻┻┻━━┻━┻━━┻━━┻━━╯╰╯╱╰┻━━┻┻┻┻┻╯╰╯    |
--]]
...
print(Time)
 ...
 Notify({
	 Description = "Bandu’s Admin currently has ".. commandcount .. " commands";
	 Title = "Bandu’s Admin";
	 Duration = 5;
...
if b:IsA("Folder") then
 ...
 cmd.add({"admin"}, {"admin", "whitelist someone to allow them to use commands"}, function(...)
	 ...
	 if Player ~= nil and not Admin[Player.UserId] then
		 ...
		 ChatMessage("/w "..Player.Name.." [Bandu’s Admin] You've got admin. Prefix: ';'")
		 wait(0.2)
		 ChatMessage("/w "..Player.Name.." [Bandu’s Admin Commands] glue, unglue, fling, fling2, spinfling, unspinfling, fcd, fti, fpp, fireremotes, holdhat")
...
print(text)
 ...
 TextLabel_2.Text = "You are executing an anti-chat-log script meaning that Bandu’s Admin wouldnt be able to detect when you have chatted meaning if you are on mobile and use the chat to execute commands it wont work. Are you sure you want to execute this?"
...
game.Players.LocalPlayer.CameraMode = "LockFirstPerson"
 ...
 if table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) then 
	 ...
	 Notify({
	 Description = "Bandu’s Admin has detected you using mobile you now have a invisible button click it to enable / disable invisibility";
	 Title = "Bandu’s Admin";
	 Duration = 7;
	 });
...
-- table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) | searches if the player is on mobile.
 ...
 TextClickButton.Text = "Bandu’s Admin " .. currentversion .. ""
